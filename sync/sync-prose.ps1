# ====================================================================
# MindAttic.UiUx -> Prose.Writer + Prose.Codex
# --------------------------------------------------------------------
...
function Splice-CssMarkerBlock {
    ...
    $block = $Begin + "`r`n" +
             "/* Generated by MindAttic.UiUx/sync/sync-prose.ps1. Do not edit by hand." + "`r`n" +
...
function Sync-Subscriber {
    ...
    foreach ($subscription in $sub.subscriptions) {
        ...
        switch ($comp.name) {
            ...
            default {
                throw "Prose has no dispatch for component '$($comp.name)'. Add a case in sync-prose.ps1."
            }
        }
    }
...
Sync-Subscriber -SubscriberName 'Prose.Writer' -ContentRoot $ContentRoot
Write-Output ""
Sync-Subscriber -SubscriberName 'Prose.Codex'  -ContentRoot $ContentRoot
